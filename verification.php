    ...
    <?php
        if(isset($_GET['verificationkey'])){
            ...
            if($count > 0) {
                ...
                if(mysqli_query($conn, $sql)) {
                    ...
                    try {
                        ...
                        */
                        ...
                        echo '
                        <div class="container">
                            <h3>Your e-mail address has been successfully confirmed. You will automatically be redirected to login page after a few seconds or click <a href="login.php">here</a> to proceed now.</h3>
                        </div>';
                ...
                echo '
                <div class="container">
                    <h3 class="text-center">Invalid account or this account is already verified</h3>
                </div>';
            }
        }else{
