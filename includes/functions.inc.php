<?php
    ...
    function createUser($conn, $firstname, $lastname, $email, $password, $vkey) {

        $sql = "INSERT INTO users (f_name, l_name, email, password, verification_key) VALUES (?, ?, ?, ?, ?);";
        ...
        mysqli_stmt_bind_param($stmt, "sssss", $firstname, $lastname, $email, $hashedPassword, $vkey);
